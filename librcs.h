...
class rcspdf_Name:public rcspdf_Object {
  protected:
    char* value;
  public:
    LINK rcspdf_Name(char* v);
    LINK virtual ~rcspdf_Name();
    LINK virtual void _print(int fildes);
    LINK char*   getValue();
    LINK void rcspdf_Name::readValue(int fildes);
  };
...
class rcspdf_Dictionary:public rcspdf_Object {
  ...
  public:
    ...
    LINK virtual void _print(int fildes);
    LINK rcspdf_Object* getEntry(char* key);
    LINK void update(char* key,rcspdf_Object* obj);
    LINK int  itemCount();
    LINK rcspdf_Name* getKeyAt(int pos);
    LINK rcspdf_Object* getValueAt(int pos);
    LINK void rcspdf_Dictionary::readValue(int fildes);
  };
...
class rcspdf_Page:public rcspdf_Dictionary {
  ...
  public:
    ...
    LINK void addResource(char* typ,char* name,rcspdf_Object* obj);
